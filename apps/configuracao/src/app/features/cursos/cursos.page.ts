...
export class CursosPage {
  ...
  protected readonly errorMessage = computed<string | null>(() => {
    ...
    // `useCursorObsoletoRecovery`) e avisa por notificação — sem alerta
    // vermelho de "não foi possível carregar", que descreveria mal um estado
    // que já está se resolvendo.
