...
export const STEP_LABELS = [
  'Tipo edital', 'Identificação', 'Modalidades', 'Vagas', 'Etapas',
...
export const TIPO_PROCESSO_OPTIONS: TipoProcessoOption[] = [
  { value: 'sisu', name: 'SiSU', description: 'Sistema de Seleção Unificada — utiliza notas do ENEM para classificação. Notas obtidas via integração com INEP, sem prova local.', tags: ['2 opções'], legal: 'Portaria MEC 21/2012; Lei 12.711/2012 atualizada pela Lei 14.723/2023' },
  { value: 'psiq', name: 'PSIQ — Indígena e Quilombola', description: 'Processo Seletivo Especial para candidatos indígenas e quilombolas, com vagas suplementares e prova presencial em 3 polos.', tags: ['2 opções', 'Presencial', 'Suplementares'], legal: 'Resolução Unifesspa 532/2021' },
  { value: 'pse', name: 'PSE — Educação do Campo', description: 'Processo Seletivo Especial para Licenciatura em Educação do Campo. Exige declaração de pertencimento territorial e entrevista.', tags: ['Presencial'], legal: 'Resolução Unifesspa 805/2024' },
  { value: 'psvr', name: 'PSVR — Vestibular Remanescente', description: 'Processo Seletivo para vagas remanescentes após SiSU. Utiliza prova presencial objetiva + redação.', tags: ['Presencial'], legal: 'Portaria MEC 18/2012; Resolução CONSEPE Unifesspa' },
  { value: 'ps-convenios', name: 'PS Convênios', description: 'Processo Seletivo de cursos por convênio com municípios. Aplica bônus regional configurável (padrão 20% sobre AC).', tags: ['Presencial'], legal: 'PN MEC 2.027/2023; Resolução Unifesspa do convênio específico' },
  { value: 'mobin', name: 'Transferência Interna (MOBIN)', description: 'Mobilidade interna entre cursos da Unifesspa. Análise de histórico e carta de intenção.', tags: [], legal: 'Resolução Unifesspa 414/2020' },
  { value: 'mobex', name: 'Transferência Externa (MOBEX)', description: 'Mobilidade externa de outras IFES para a Unifesspa. Análise de histórico e carta de intenção.', tags: [], legal: 'Resolução Unifesspa 414/2020' },
  { value: 'portador-diploma', name: 'Portador de Diploma', description: 'Ingresso para portadores de diploma de curso superior. Análise de histórico de graduação anterior.', tags: [], legal: 'Resolução Unifesspa 414/2020' },
];

export const MODALIDADES = [
  { id: 'ac', code: 'AC', label: 'Ampla Concorrência' },
  { id: 'v', code: 'V', label: 'Pessoa com Deficiência (Ampla Concorrência)' },
  { id: 'lb-q', code: 'LB_Q', label: 'Baixa Renda + Quilombola' },
  { id: 'lb-pcd', code: 'LB_PcD', label: 'Baixa Renda + Pessoa com Deficiência' },
  { id: 'li-ppi', code: 'LI_PPI', label: 'Independente de Renda + PPI (Pretos, Pardos ou Indígenas)' },
  { id: 'li-q', code: 'LI_Q', label: 'Independente de Renda + Quilombola' },
  { id: 'li-ep', code: 'LI_EP', label: 'Independente de Renda — Demais (Escola Pública)' },
] as const;

export const MODALIDADES_CANONICAS = ['AC', 'V', 'LB_PPI', 'LB_Q', 'LB_PcD', 'LB_EP', 'LI_PPI', 'LI_Q', 'LI_PcD', 'LI_EP'] as const;
...
export const POLOS = [
  'Marabá (PA)', 'Canaã dos Carajás (PA)', 'Rondon do Pará (PA)', 'Santana do Araguaia (PA)',
  'São Félix do Xingu (PA)', 'Xinguara (PA)', 'Abel Figueiredo (PA)', 'Água Azul do Norte (PA)',
  'Almeirim (PA)', 'Anapu (PA)', 'Bannach (PA)', 'Bom Jesus do Tocantins (PA)',
  'Brejo Grande do Araguaia (PA)', 'Conceição do Araguaia (PA)', 'Cumaru do Norte (PA)',
  'Curionópolis (PA)', 'Dom Eliseu (PA)', 'Eldorado dos Carajás (PA)', 'Floresta do Araguaia (PA)',
  'Goianésia do Pará (PA)', 'Itupiranga (PA)', 'Jacundá (PA)', 'Novo Repartimento (PA)',
  'Ourilândia do Norte (PA)', 'Palestina do Pará (PA)', 'Parauapebas (PA)', 'Piçarra (PA)',
  'Redenção (PA)', 'Rio Maria (PA)', 'São Domingos do Araguaia (PA)', 'São Geraldo do Araguaia (PA)',
  'São João do Araguaia (PA)', 'Sapucaia (PA)', 'Tucumã (PA)', 'Tucuruí (PA)',
] as const;
...
export const ATENDIMENTO_CONDICOES: AtendimentoCondicao[] = [
  ...
  { id: 'gest', nome: 'Gestante' }, { id: 'lact', nome: 'Lactante' },
...
export const ATENDIMENTO_RECURSOS: AtendimentoRecurso[] = [
  ...
  { id: 'acomp-lac', nome: 'Acompanhante para o lactente', desc: 'Adulto acompanhante para cuidar da criança durante a prova da lactante.', ext: true },
  { id: 'sala-ind', nome: 'Sala individual ou reduzida', desc: 'Sala com poucos candidatos para redução de estímulos (TEA, TDAH).', ext: true },
];

export const PCD_TIPOS = [
  'Deficiência física', 'Deficiência visual — Cegueira', 'Deficiência visual — Baixa visão',
  'Deficiência auditiva — Surdez severa/profunda', 'Deficiência auditiva — Surdez parcial',
  'Deficiência intelectual', 'Deficiência psicossocial', 'Deficiência múltipla',
  'Transtorno do espectro autista (TEA)', 'Altas habilidades / Superdotação',
] as const;
