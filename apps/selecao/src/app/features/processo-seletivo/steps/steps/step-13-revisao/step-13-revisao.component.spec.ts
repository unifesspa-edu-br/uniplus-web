...
import { Step13RevisaoComponent } from './step-13-revisao.component';

function anexo(fase: FaseUpload): UploadItem {
  return { id: 'u1', name: 'edital.pdf', extension: 'pdf', progress: 100, fase };
}

describe('Step13RevisaoComponent', () => {
  let componente: Step13RevisaoComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [Step13RevisaoComponent],
      providers: [
    ...
    const fixture = TestBed.createComponent(Step13RevisaoComponent);
