...
import { ModalidadesStepComponent } from './modalidades.component';
...
describe('ModalidadesStepComponent', () => {
  let componente: ModalidadesStepComponent;
  let store: ProcessoSeletivoStore;
  let controller: HttpTestingController;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ModalidadesStepComponent],
      providers: [
    ...
    const fixture = TestBed.createComponent(ModalidadesStepComponent);
