...
import { Step05EtapasComponent } from './step-05-etapas.component';
import { ProcessoSeletivoStore } from '../../processo-seletivo.store';

describe('Step05EtapasComponent', () => {
  let componente: Step05EtapasComponent;
  let store: ProcessoSeletivoStore;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [Step05EtapasComponent],
      providers: [ProcessoSeletivoStore],
    }).compileComponents();

    const fixture = TestBed.createComponent(Step05EtapasComponent);
